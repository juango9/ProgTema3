...
show(p)
#"se" nos ayuda a quitar cuando esta en false la malla gris
```
...
library(readr)
#Lectura fichero csv
owid_covid_data_1_<- read_csv("data/owid-covid-data (1).csv", 
    col_types = cols(date = col_date(format = "%Y-%m-%d")))
#Transformacion de los datos
pais <- c('United States','Italy','France','Germany','Canada','Japan','United Kingdom','Spain')
#Una vez tenemos la lista de paises a representar los cambiamos por las localizaciones del csv inicial
datos_corregidos<- owid_covid_data_1_ %>%
  filter(location == pais)
graf1<-ggplot(datos_corregidos, aes(x = date, y = new_deaths_smoothed_per_million, color = location , grup = location)) + geom_line() +
  labs(title="COVID-19 muertos por millon de personas",x="Años", y = "muertos por millon de personas")+theme_classic() + scale_color_manual ( values = c ( "Canada" = "Orange" , "France" = 'Yellow', 'Germany' = 'Green', 'Italy' = 'red','Japan'='blue' ,'Spain'= 'black','United Kingdom' = ' Purple','United States' = 'pink') )
graf1
